...
function getStatusStyle(status: HomeVisitStatus) {
    switch (status) {
        case "completed":
            return { bg: "bg-emerald-50 border-emerald-200", dot: "bg-emerald-500 text-white", icon: "✓" };
        case "en_route":
            return { bg: "bg-cyan-50 border-cyan-300 shadow-sm", dot: "bg-gradient-to-br from-cyan-500 to-cyan-600 text-white", icon: "→" };
        case "arrived":
        case "in_progress":
            return { bg: "bg-cyan-50 border-cyan-300 shadow-sm", dot: "bg-gradient-to-br from-cyan-500 to-cyan-600 text-white", icon: "●" };
        case "cancelled":
            return { bg: "bg-slate-50 border-slate-200 opacity-50", dot: "bg-slate-300 text-white", icon: "✗" };
        default:
                    ...
                    {displayVisits.map((visit) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    {style.icon || formatTime(visit.planned_start).slice(0, 2) + "h"}
                                </div>
